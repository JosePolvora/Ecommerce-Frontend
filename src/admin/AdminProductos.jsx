...
//                                     <td className="px-6 py-4 whitespace-nowrap">{producto.producto_id}</td>
...
//                                     <td className="px-6 py-4 whitespace-nowrap">{producto.disponible ? <span className='text-green-500'>SI</span> : <span className='text-red-500'>NO</span>}</td>
